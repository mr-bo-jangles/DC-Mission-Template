...
UCD_cacheList = [ // List is read top-down, stops at first matching type
	...
	["Man",				false,	false,		{GLOBAL_SPAWN_DISTANCE}],
	/* Special classes for "Man" type units with(in|out) vehicles */
	["Commander",		false,	false,		{GLOBAL_SPAWN_DISTANCE}],
	["Gunner",			false,	false,		{GLOBAL_SPAWN_DISTANCE}],
	["Driver",			false,	false,		{GLOBAL_SPAWN_DISTANCE}], // Recommended not to cache unless also caching vehicle
	["Turret",			false,	false,		{GLOBAL_SPAWN_DISTANCE}],
	["Cargo",			false,	false,		{GLOBAL_SPAWN_DISTANCE}],
	["None",			false,	false,		{GLOBAL_SPAWN_DISTANCE}], // A.K.A units not in vehicles
